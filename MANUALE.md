...
- **Fasi successive** (non ancora fatte, vedi Linear TOU-21): area partner, CRM interno (repository `touchandgo-internal`), sito pubblico — stesso modello di design token, PR separate.
